...
class Inimigos {
  ...
  aparece(cenario, personagem) {
    if (!(this.morreu)) {
      ...
      var matou = collideRectRect(personagem.redusX, personagem.yForca + personagem.cenarioIni - cenario.scrollPer + personagem.bloco / 2, personagem.bloco, personagem.bloco,
        this.x - personagem.bloco * 0.2, this.y - cenario.scrollPer + personagem.bloco, personagem.bloco * 1.3, personagem.bloco);
